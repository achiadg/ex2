...
write.csv(res,file="C:/Users/אחיעד/Desktop/data science/ass2/prediction1/output4.csv",row.names = F)
```
...
we tuned the names of each of the 3 algorhitm we used: c5.0, rpart and gbm using the train method of the caret library. we also used the train method to tune the metric of the model to be "accuracy" which is what we interested in.
